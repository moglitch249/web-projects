            ...
            <main class="single-post-main">
                ...
                <article <?php post_class('single-post-article'); ?> id="post-<?php the_ID(); ?>">
                    ...
                    <div class="post-featured-img">
                        <?php the_post_thumbnail('owizo-hero', ['class' => 'post-hero-img', 'loading' => 'eager']); ?>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="post-share">
                        ...
                        <button class="share-btn share-copy" data-url="<?php echo esc_attr(get_permalink()); ?>" onclick="navigator.clipboard.writeText(this.dataset.url).then(()=>window.owizoShowToast&&window.owizoShowToast('Link copied!','success'))">
