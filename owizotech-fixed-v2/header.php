                ...
                <a href="<?php echo esc_url( home_url('/') ); ?>" class="brand-link" rel="home" aria-label="<?php bloginfo('name'); ?>">
                    <?php if ( $owizo_logo ) : ?>
                        <img src="<?php echo esc_url($owizo_logo); ?>"
                             ...
                             style="height:<?php echo esc_attr($owizo_height); ?>px;max-height:<?php echo esc_attr($owizo_height); ?>px;width:auto;max-width:200px;display:block;object-fit:contain;"
                             loading="eager">
