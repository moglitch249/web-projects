        ...
        <div class="container">
            ...
            <div class="archive-hero-content">
                <span class="section-label">
                    <?php if (is_category()) : ?>
                    <?php _e('Category', 'owizotech'); ?>
                    <?php elseif (is_tag()) : ?>
                    <?php _e('Tag', 'owizotech'); ?>
                    <?php elseif (is_author()) : ?>
                    <?php _e('Author', 'owizotech'); ?>
                    <?php else : ?>
                    <?php _e('Blog', 'owizotech'); ?>
                    <?php endif; ?>
                </span>
                <h1 class="archive-hero-title"><?php echo wp_kses_post( get_the_archive_title() ); ?></h1>
    ...
    <div class="container">
        <div class="archive-content-wrap">
            ...
            <div class="archive-count">
                <?php printf( __('%d posts', 'owizotech'), $wp_query->found_posts ); ?>
            </div>
